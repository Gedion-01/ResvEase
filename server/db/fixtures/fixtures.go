...
func AddRoom(store *db.Store, name string, description string, price float64, capacity int, amenities []string, images []string, bedtype string, bedrooms int, hid primitive.ObjectID) *types.Room {
	room := &types.Room{
		Name:        name,
